...
public class StringCalculatorTest {
    ...
    @Test
    @DisplayName("should return a number on single string")
    public void testSingleNumber(){
        assertEquals(1,stringCalculator.add("1"));
    }

    @Test
    @DisplayName("should return a sum for multiple numbers")
    ...
    @Test
    @DisplayName("should return a sum with new line delimiter string")
    public void testNewLineDelimiter(){
        assertEquals(16,stringCalculator.add("1\n2,13"));
    }

    @Test
    @DisplayName("should throw a error for invalid delimiter pattern")
    public void testInvalidLineDelimiter(){
        assertThrows(IllegalArgumentException.class,()->stringCalculator.add("1,\n,2"));
    }

    @Test
    @DisplayName("should return a sum for custom delimiter")
    ...
    @Test
    @DisplayName("should throw an exception for negative numbers")
    ...
    @Test
    @DisplayName("should return a sum by ignoring value greater than 1000")
    ...
    @Test
    @DisplayName("should return a sum for lengthy custom delimiter")
    ...
    @Test
    @DisplayName("should return a sum for multiple custom delimiters")
    ...
    @Test
    @DisplayName("should throw an exception for non integer values")
